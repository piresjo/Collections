    ...
    try {
        ...
        await connection.query(
            ...
            function (error, results) {
                ...
                results[0].region_string = DERIVE_REGION_STRING(
                    results[0].region
                )
                        ...
                        const entry = {
                            ...
                            bought_date:
                                console['Bought Date'] === ''
                                    ...
                                    : console['Bought Date'],
                            company:
                                console.Company === '' ? null : console.Company,
                            ...
                            has_packaging:
                                ...
                                'yes',
                            is_duplicate:
                                console['Is Duplicate'].toLowerCase() === 'yes',
                            has_cables:
                                console['Has Cables'].toLowerCase() === 'yes',
                            has_console:
                                console['Has Console'].toLowerCase() === 'yes',
                            monetary_value:
            ...
            .on('end', (rowCount) => {
                ...
                accessoryList.forEach((accessory) => {
                    try {
                        const entry = {
                            console_id:
                                ConsolesAndIds[accessory.Console.toLowerCase()],
                            name: accessory.Name,
